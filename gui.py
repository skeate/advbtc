...
class MainWindow ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.m_notebook1.AddPage( self.addrPanel, _(u"Personal Addresses"), False )
		...
		self.m_staticText16 = wx.StaticText( self.txSimplePanel, wx.ID_ANY, _(u"Recipient:"), wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText16.Wrap( -1 )
		gbSizer3.Add( self.m_staticText16, wx.GBPosition( 1, 1 ), wx.GBSpan( 1, 1 ), wx.ALIGN_RIGHT|wx.ALL, 5 )
		
		self.txSimpleRecipient = wx.TextCtrl( self.txSimplePanel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		gbSizer3.Add( self.txSimpleRecipient, wx.GBPosition( 1, 2 ), wx.GBSpan( 1, 2 ), wx.ALL|wx.EXPAND, 5 )
		
		self.m_staticText17 = wx.StaticText( self.txSimplePanel, wx.ID_ANY, _(u"Amount (BTC):"), wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText17.Wrap( -1 )
		gbSizer3.Add( self.m_staticText17, wx.GBPosition( 2, 1 ), wx.GBSpan( 1, 1 ), wx.ALIGN_RIGHT|wx.ALL, 5 )
		
		self.txSimpleAmount = wx.TextCtrl( self.txSimplePanel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		gbSizer3.Add( self.txSimpleAmount, wx.GBPosition( 2, 2 ), wx.GBSpan( 1, 2 ), wx.ALL|wx.EXPAND, 5 )
		
		
		gbSizer3.AddSpacer( ( 10, 10 ), wx.GBPosition( 5, 4 ), wx.GBSpan( 1, 1 ), wx.EXPAND, 5 )
		
		self.txSimpleSendBtn = wx.Button( self.txSimplePanel, wx.ID_ANY, _(u"Send"), wx.DefaultPosition, wx.DefaultSize, 0 )
		gbSizer3.Add( self.txSimpleSendBtn, wx.GBPosition( 3, 1 ), wx.GBSpan( 1, 3 ), wx.ALIGN_CENTER|wx.ALL|wx.EXPAND, 5 )
		
		self.txSimpleClearBtn = wx.Button( self.txSimplePanel, wx.ID_ANY, _(u"Clear"), wx.DefaultPosition, wx.DefaultSize, 0 )
		gbSizer3.Add( self.txSimpleClearBtn, wx.GBPosition( 4, 1 ), wx.GBSpan( 1, 3 ), wx.ALIGN_CENTER_HORIZONTAL|wx.ALL|wx.EXPAND, 5 )
		
		
		gbSizer3.AddGrowableRow( 0 )
		gbSizer3.AddGrowableRow( 5 )
		
		self.txSimplePanel.SetSizer( gbSizer3 )
		self.txSimplePanel.Layout()
		gbSizer3.Fit( self.txSimplePanel )
		...
		self.txMultiPanel = wx.Panel( self.m_listbook1, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL )
		self.m_listbook1.AddPage( self.txMultiPanel, _(u"Multi"), False )
		...
		self.m_notebook1.AddPage( self.bookPanel, _(u"Address Book"), False )
		...
		self.txSimpleSendBtn.Bind( wx.EVT_BUTTON, self.txSimpleSend )
		self.txSimpleClearBtn.Bind( wx.EVT_BUTTON, self.txSimpleClear )
